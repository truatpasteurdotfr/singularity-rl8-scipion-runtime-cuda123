...
yum -y update && \
dnf -y install \
	cuda-minimal-build-12-3.x86_64 \
	libcufft-devel-12-3.x86_64 \
	libcurand-devel-12-3.x86_64 \
	cuda-nvtx-12-3.x86_64 \
	libcublas-devel-12-3.x86_64 \
	cuda-nvml-devel-12-3.x86_64 \
	&& \
yum -y clean all
